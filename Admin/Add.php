		...
		<div class="section1">
			<div class="boxes">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="box add">
						<input type="submit" name="submit" value="Add Now" class="submit-btn">
					</div>
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit']) && $_POST['submit'] == "Add Now") {
	...
	$query = "SELECT * FROM `trip` WHERE `Trip_name` = '$Name'";
	$result = mysqli_query($con, $query);

	if (mysqli_num_rows($result) > 0) {
		echo "<script> alert('This Trip Already Exists!')</script>";
	} else {
		// Insert new trip data into the database
		$insertQuery = "INSERT INTO `trip` (Trip_name, Trip_old_price, Trip_new_price, Trip_date, Trip_description, Hot_offer,
         Trip_photo, Highlights1, Highlights2, Highlights3, Highlights4, Highlights5, Highlights6, Highlights7, Trip_photo2, Trip_photo3) 
         VALUES ('$Name', '$OldPrice', '$NewPrice', '$Duration', '$Description', '$HotOffer', '$Photo', '$Highlights1', '$Highlights2', 
         '$Highlights3', '$Highlights4', '$Highlights5', '$Highlights6', '$Highlights7', '$Photo2', '$Photo3')";
